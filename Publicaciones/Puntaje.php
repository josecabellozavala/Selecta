<?php
	...
	for($x = 0; $x < count($tipo_copei); $x++)
	{
		...
		{
			$tipo = array("2.1.a","2.1.b","2.1.c","2.1.d","2.1.e","2.1.f","2.1.g","2.2","2.3","2.4","2.5","2.7.a","2.7.b","2.7.c","2.8.a","2.8.b","2.8.c","2.8.d","2.8.e","2.8.f","2.9","2.10.a","2.10.b","2.10.c","2.11.a","2.11.b","2.11.c","2.12.a","2.12.b","2.12.c","2.12.d");
		...
		else if($tipo[0] == "3")
		{
			...
			for($y = 0; $y < count($producto); $y++)
			{
				$autores = $conexion->Consultas("SELECT COUNT(ID_Usuario_Tesis) AS Total FROM Usuario_Tesis WHERE FK_Tesis = ".$producto[$y]["ID_Tesis"]." AND Estudiante = 0");
